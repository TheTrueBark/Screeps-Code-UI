...
export const nodes: Record<string, NodeMeta> = {
  "memory.read": {
    ...
    docs: {
      ...
      outputs:
        "- **Value:** Retrieved value or the provided default when missing.",
  ...
  "memory.write": {
    ...
    docs: {
      ...
      notes:
        "When merge is enabled and both values are objects they are shallow-merged.",
    },
    codegen: { emitter: "memory" },
  },
  "memory.delete": {
    ...
    docs: {
      ...
      notes:
        "No inputs are required; the node simply deletes the key when executed.",
    },
    codegen: { emitter: "memory" },
  },
};

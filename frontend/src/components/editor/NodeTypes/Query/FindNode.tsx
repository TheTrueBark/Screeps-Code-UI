...
const baseDefinition: Omit<NodeDefinition, 'Component'> = {
  ...
  title: 'Find',
  subtitle: 'Query',
  description: 'Search for game objects using Screeps find constants and optional filters.',
  family: 'query',
  ...
  configFields: [
    { type: 'select', name: 'findConstant', label: 'Find constant', options: FIND_OPTIONS },
    {
      type: 'select',
      name: 'mode',
      label: 'Mode',

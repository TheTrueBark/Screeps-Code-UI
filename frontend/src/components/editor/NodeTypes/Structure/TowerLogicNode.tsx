...
const baseDefinition: Omit<NodeDefinition, 'Component'> = {
  ...
  title: 'Tower Logic',
  subtitle: 'Structure',
  description: 'Configure priorities for tower healing, attacking and repairing.',
  family: 'structure',
  ...
  configFields: [
    ...
    { type: 'number', name: 'healThreshold', label: 'Heal threshold', min: 0, max: 1, step: 0.05 },
    { type: 'number', name: 'repairThreshold', label: 'Repair threshold', min: 0, max: 1, step: 0.05 }
  ],
  dataInputs: [

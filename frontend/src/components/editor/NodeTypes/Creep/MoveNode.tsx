...
const baseDefinition: Omit<NodeDefinition, 'Component'> = {
  ...
  title: 'Move',
  subtitle: 'Creep',
  description: 'Move a creep using the selected pathing adapter and parameters.',
  family: 'creep',
  ...
  configFields: [
    { type: 'select', name: 'adapter', label: 'Adapter', options: MOVE_ADAPTERS },
  ...
  dataInputs: [
    ...
    { name: 'targetPos', label: 'Target', handleId: 'input:targetPos', optional: false }
  ]
};
